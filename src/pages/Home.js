...
import foodGirl from "../asset/ngo6.png";
import falimy from "../asset/ngo2.png";
import FoodHandout from "../asset/ngo1.png";
        ...
        <div className="max-w-[100vw]">
          ...
          <section className="     relative  h-fit">
            ...
            <div className="absolute   top-0  left-0 h-full w-full flex items-center justify-center  md:flex-row flex-col     gap-8  p-4 ">
              <div className="flex flex-col    gap-4  w-full md:w-[40rem] ">
                <h1 className="  text-[#0056D2]    font-bold  text-3xl   text-center md:text-start  md:text-7xl">
                Food for All, Hope for Many
                </h1>
                <p className=" text-white font-bold text-center md:text-start">
                Join us in making a difference with every meal.
                Our platform connects those with extra food to those in need.
                </p>
              </div>
              <div className="w-full md:w-[40rem]  md:flex  items-center justify-center">
                <div className="flex flex-col gap-4    md:gap-9     md:justify-start    items-center justify-center">
                  <h1 className="text-[#0056D2]   md:text-2xl  text-center   font-bold  md:text-start">
                    CHOOSE AN OCCASION
                  </h1>
          ...
          <section className=" flex   justify-center    md:my-[5rem]  my-10 px-4">
            <div className=" max-w-4xl   flex  flex-col  gap-10">
              <h1 className=" text-center text-[#0056D2]   md:text-7xl    text-3xl   font-bold ">
            ...
            <div>
              <div className="flex   flex-col md:flex-row">
                <div className=" md:w-[24rem] w-full      p-8 bg-[#38067d] text-white  items-center flex  flex-col gap-6 ">
                  ...
                  The Akshaya Patra Foundation
                    ...
                    <li>Mission: Eradicate classroom hunger</li>
                    <li>What It Does: Provides nutritious meals to school children</li>
                  </ul>
                </div>
                <img
                  src={FoodHandout}
              ...
              <div className="flex flex-col-reverse md:flex-row">
                ...
                <div className="md:w-[24rem]  w-full p-8  text-gray-800  items-center flex ">
                  ...
                  Annamrita Foundation<br></br>

- Location: Delhi<br></br>
- Mission: Combat child hunger and malnutrition<br></br>
- What It Does: Provides nutritious meals to children
                  </p>
                </div>
              </div>
              <div className="flex flex-col md:flex-row">
        ...
        - Mission: Eliminate hunger and food wastage<br></br>
        - What It Does: Provides meals to underserved communities and redistributes surplus food
          ...
          <div className="container">
            ...
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                <a
                  href="https://www.instagram.com/shreyagarg0707/"
                  className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
                >
                  <svg
                    className="w-5 h-5"
